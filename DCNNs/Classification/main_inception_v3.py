...
def train(single_model,model, train_data, test_data, save_weights):
    ...
    # callbacks
    log = callbacks.CSVLogger('weights/inception_v3/'+ args.save_weights + '/log.csv')
    tb = callbacks.TensorBoard(log_dir='weights/inception_v3/'+ args.save_weights + '/tensorboard-logs',
    ...
    checkpoint = ParallelModelCheckpoint(single_model, 'weights/inception_v3/'+ args.save_weights + '/weights-{epoch:03d}.h5', monitor='val_acc',
    ...
    model.fit_generator(generator=train_data,
                        ...
                        callbacks=[log, tb, checkpoint,lrate,early_stopping],
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="InceptionV3 Network")
    ...
    # save weights
    model.save_weights(('InceptionV3_'+args.save_weights+'_trained_weights.h5'))
