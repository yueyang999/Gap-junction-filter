...
def train(single_model,model, train_data, test_data, save_weights):
    ...
    # callbacks
    log = callbacks.CSVLogger('weights/vgg19/'+ args.save_weights + '/log.csv')
    tb = callbacks.TensorBoard(log_dir='weights/vgg19/'+ args.save_weights + '/tensorboard-logs',
    ...
    checkpoint = ParallelModelCheckpoint(single_model, 'weights/vgg19/'+ args.save_weights + '/weights-{epoch:03d}.h5', monitor='val_acc',
