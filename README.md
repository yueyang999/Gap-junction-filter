...
from the paper [Generalisation in humans and deep neural networks](https://arxiv.org/abs/1808.08750). The runing sample follows: 'python main_resnet50.py --gpus=4 --train_data=p20_train_G-filter --test_data=w0.05_G-filter --save_weights=p20_gap5' (Training Model)
