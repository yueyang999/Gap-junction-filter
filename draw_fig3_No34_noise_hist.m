...
s6=sprintf("data/denoising/Filtered/Uniform/test034_onepass.png");
s7=sprintf("data/denoising/Filtered/Salt_and_Pepper/test034_onepass.png");
s8=sprintf("data/denoising/Filtered/Gaussian/test034_onepass.png");
s9=sprintf("data/denoising/Filtered/Mixed/test034_onepass.png");
...
category2=char('Unifrom noise after PR-filter','S&P noise after PR-filter','Gaussian noise after PR-filter','Mixed noise after PR-filter');
