...
def train(single_model,model, train_data, test_data, save_weights):
    ...
    # callbacks
    log = callbacks.CSVLogger('/raid/yy/weights/inception_v3/'+ args.save_weights + '/log.csv')
    tb = callbacks.TensorBoard(log_dir='/raid/yy/weights/inception_v3/'+ args.save_weights + '/tensorboard-logs',
    ...
    checkpoint = ModelCheckpoint('/raid/yy/weights/inception_v3/'+ args.save_weights + '/weights-{epoch:03d}.h5', monitor='val_accuracy',
...
if __name__ == "__main__":
    ...
    # save weights
    model.save_weights(('/raid/yy/weights/inception_v3/'+args.save_weights+'_trained_weights.h5'))
