...
for i=1:68
    if(i<10)
        ...
        s4=sprintf("data/denoising/Filtered/Uniform/test00%d_onepass.png",i);
        s5=sprintf("data/denoising/Filtered/Salt_and_Pepper/test00%d_onepass.png",i);
        s7=sprintf("data/denoising/Filtered/Gaussian/test00%d_onepass.png",i);
        s9=sprintf("data/denoising/Filtered/Mixed/test00%d_onepass.png",i);
        ...
        s4=sprintf("data/denoising/Filtered/Uniform/test0%d_onepass.png",i);
        s5=sprintf("data/denoising/Filtered/Salt_and_Pepper/test0%d_onepass.png",i);
        s7=sprintf("data/denoising/Filtered/Gaussian/test0%d_onepass.png",i);
        s9=sprintf("data/denoising/Filtered/Mixed/test0%d_onepass.png",i);
...
category1=char('Before PR Filter','After PR-filter');
category2=char('Before PR Filter','After PR-filter');
category3=char('Before PR Filter','After PR-filter');
category4=char('Before PR Filter','After PR-filter');
category5=char('Unifrom noise after PR-filter','S&P noise after PR-filter','Gaussian noise after PR-filter','Mixed noise after PR-filter');
figure(1);
subplot(1,5,1);
